...
$error = "";
$username_value = ""; // Giữ lại giá trị username nếu nhập sai
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Code kiểm tra đăng nhập (Hard-code để test: admin / 123456)
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Đăng nhập hệ thống - ERP</title>
    ...
    <!-- Các thư viện phụ trợ (Giữ nguyên từ template) -->
                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="assets/img/illustrations/signin.svg">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="" method="POST" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <!-- Đã sửa type="email" thành type="text" để nhập được username "admin" -->
                                        <!-- Thêm name="username" để PHP bắt được -->
                                        <input type="text" name="username" class="form-control" placeholder="example@company.com" id="email" value="<?php echo htmlspecialchars($username_value); ?>" autofocus required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <!-- Thêm name="password" để PHP bắt được -->
                                    ...
                                    <div class="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div>
                                            <a href="#" class="small text-right">Quên mật khẩu?</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-grid">
                            ...
                            <!-- Phần Social Login (Có thể ẩn đi nếu không dùng) -->
                            <div class="mt-3 mb-4 text-center">
                                <span class="fw-normal">hoặc đăng nhập bằng</span>
                            </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">Chưa có tài khoản? <a href="#" class="fw-bold">Tạo tài khoản</a></span>
                            </div>
                        </div>
                    </div>
                </div>
